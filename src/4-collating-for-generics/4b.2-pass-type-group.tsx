...
type ThemeShapeForComponent<ComponentMeta extends ShapeForComponentMeta> = {
  [key in ComponentMeta['VariantName']]: Partial<
    {
      [key in ComponentMeta['ElementName']]: Partial<ComponentMeta['ElementRecord']>;
    }
  >;
};
